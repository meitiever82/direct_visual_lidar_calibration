...
class SensorEntity : public type::Entity<ViewTemplate, MetaType, StoreType> {
 public:
  SensorEntity() :
      orientation_manifold_(new ceres::EigenQuaternionParameterization()),
      relative_position_locked_(true),
      relative_orientation_locked_(true),
      time_offset_locked_(true) {
      // 0: Relative orientation
      this->pstore_->AddParameter(4, orientation_manifold_.get());
  ...
  void AddToProblem(ceres::Problem &problem,
    ...
    problem.AddParameterBlock(pi_qct.data, pi_qct.size, pi_qct.manifold);
    ...
    problem.AddParameterBlock(pi_pct.data, pi_pct.size, pi_pct.manifold);
    ...
    problem.AddParameterBlock(pi_offset.data, pi_offset.size, pi_offset.manifold);
 ...
 protected:
  ...
  std::unique_ptr<ceres::EigenQuaternionParameterization> orientation_manifold_;
};
