...
class ImuEntity : public SensorEntity<ViewTemplate, MetaType, StoreType> {
 ...
 public:
   ...
   void AddToProblem(ceres::Problem &problem,
     ...
     problem.AddParameterBlock(p_gravity_roll.data, p_gravity_roll.size, p_gravity_roll.manifold);
     parameters.push_back(p_gravity_roll);

     auto p_gravity_pitch = this->pstore_->Parameter(this->PARAM_GRAVITY_PITCH);
     problem.AddParameterBlock(p_gravity_pitch.data, p_gravity_pitch.size, p_gravity_pitch.manifold);
