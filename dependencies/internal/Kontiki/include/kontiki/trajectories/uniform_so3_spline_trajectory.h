...
struct SO3SplineControlPointInfo : public ControlPointInfo<Eigen::Quaternion<T>, 4> {
  SO3SplineControlPointInfo() :
    manifold_(new ceres::EigenQuaternionParameterization) { };
  ...
  ceres::LocalParameterization *manifold() const override {
    return manifold_.get();
  }

  std::unique_ptr<ceres::EigenQuaternionParameterization> manifold_;
};
